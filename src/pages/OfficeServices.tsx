...
const OfficeServices = () => {
  ...
  return (
    <div className="min-h-screen">
      <Seo
        title="العمالة المنزلية - مكتب كنان الأمل للتنازل عن العاملات المنزلية"
        description="العمالة المنزلية متخصصة في التنازل عن العاملات المنزلية ونقل الكفالة في الرياض. خدمات شاملة وموثوقة."
        ...
        <div className="max-w-7xl mx-auto text-center relative z-10">
          <div className="fade-in-up">
            <h1 className="text-5xl md:text-7xl font-bold mb-8 arabic-heading leading-tight">
              <span className="text-white drop-shadow-lg">العمالة المنزلية</span>
              <br />
              <span className="text-yellow-300 drop-shadow-lg">مكتب كنان الأمل</span>
            </h1>
            <p className="text-lg md:text-xl mb-8 arabic-text opacity-95 max-w-4xl mx-auto leading-relaxed">
            نقدم خدمات العمالة المنزلية والتنازل عن العاملات المنزليات بأعلى معايير الجودة والمهنية، مع ضمان توفير أفضل الجنسيات المدربة والمؤهلة لخدمة عملائنا الكرام
            </p>
